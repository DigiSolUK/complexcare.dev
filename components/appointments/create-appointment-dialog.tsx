...
export function CreateAppointmentDialog({ patients, providers, onSuccess, trigger }: CreateAppointmentDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>{trigger || <Button>Create Appointment</Button>}</DialogTrigger>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Create New Appointment</DialogTitle>
          <DialogDescription>Schedule a new appointment for a patient with a care professional.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
